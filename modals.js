...
function dropRock() {
  ...
  function showtipf() {
    console.log("Tip 1 is displayed.");
}

function showtipa() {
    console.log("Tip 2 is displayed.");
}

function showtipc() {
    console.log("Tip 3 is displayed.");
}

function showtipco() {
    console.log("Tip 4 is displayed.");
}

function showtip() {
    const tips = document.querySelectorAll('.tips'); // Select all elements with the class "tips"
